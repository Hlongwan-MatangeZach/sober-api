...
namespace SoberPath_API.Migrations
{
    ...
    [Migration("20250923182057_sfdghfjgkl")]
    partial class sfdghfjgkl
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SoberPath_API.Models.RoomAllocation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SoberPath_API.Models.RoomAllocation", b =>
                {
                    b.HasOne("SoberPath_API.Models.Client", "Client")
                        .WithMany()
                        .HasForeignKey("ClientId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SoberPath_API.Models.Room", "Room")
                        .WithMany()
